...
List<IGraphic2D> shapes = new List<IGraphic2D> {
    new Circle(10, 10, 5) { BackgroundColor = ConsoleColor.DarkYellow, DisplayChar = ' ' }, // yellow head
    ...
    new Rectangle(8, 13, 4, 0.5m) { ForegroundColor = ConsoleColor.DarkGray, DisplayChar = 'v' }, //mouth
    new Rectangle(8, 16, 4, 10) {  ForegroundColor = ConsoleColor.DarkGreen, DisplayChar = '#' } // body
};
